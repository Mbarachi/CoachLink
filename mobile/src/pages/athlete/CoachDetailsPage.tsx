...
import {
  AppButton, AppCard, AppPage, InitialsAvatar,
  SectionHeading, StatusPill, StickyFooter,
} from '@/components/ui';
    ...
    <AppPage>
      ...
      <div style={{ flex: 1, overflowY: 'auto' }}>
        ...
        <div style={{ padding: '0 var(--cl-px)', marginTop: -36, position: 'relative' }}>
          <InitialsAvatar initials={initials} size={72} radius={20} fontSize={24} style={{ border: '3px solid var(--cl-canvas)' }} />
          ...
          <p style={{ fontSize: 13.5, lineHeight: 1.55, color: 'var(--cl-muted-3)', margin: 0 }}>{coach.bio}</p>
          ...
          <AppCard padding={14} style={{ borderRadius: 15 }}>
