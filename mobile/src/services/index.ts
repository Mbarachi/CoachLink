...
import { bookingsService as nestBookings } from './bookings.service';
...
import { bookingsService as fbBookings } from './firebase/bookings.service';
...
export const bookingsService = isFirebaseBackend ? fbBookings : nestBookings;
